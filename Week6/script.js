const activities = [
    { city: 'telaviv', type: 'mall', name: 'Dizengoff Center Mall', image: 'https://upload.wikimedia.org/wikipedia/commons/4/48/Dizengoff_Center_Interior.jpg', mapimage:'tlv.png' },
    { city: 'telaviv', type: 'touristic', name: 'Shuk HaCarmel', image: 'https://upload.wikimedia.org/wikipedia/commons/9/99/Carmel_Market%2C_2019_%2807%29.jpg', mapimage:'tlv.png' },
    { city: 'telaviv', type: 'archeology', name: 'Eretz Israel Museum', image: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/Eretz_Israel_Museum2.jpg', mapimage:'tlv.png' },
    { city: 'telaviv', type: 'trails', name: 'Yarkon Park', image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Hayarkon-TelAviv.jpg', mapimage:'tlv.png' },
    { city: 'telaviv', type: 'religious', name: 'Great Synagogue of TLV', image: 'https://upload.wikimedia.org/wikipedia/commons/f/f7/99486_the_great_synagogue_in_tel_aviv_PikiWiki_Israel.jpg', mapimage:'tlv.png' },
    { city: 'telaviv', type: 'mall', name: 'TLV Mall', image: 'https://media.timeout.com/images/103696377/1372/772/image.webp', mapimage:'tlv.png' },
    { city: 'telaviv', type: 'touristic', name: 'Florentin', image: 'https://www.roadcalls.fr/wp-content/uploads/2019/05/quartier-florentine-tel-aviv.jpg', mapimage:'tlv.png' },
    { city: 'telaviv', type: 'archeology', name: 'Tel Grisa / Napoleon Hill', image: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Napoleon_Hill%2C_Ramat_Gan.JPG', mapimage:'tlv.png' },
